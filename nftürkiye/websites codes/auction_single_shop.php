...
async function load_nft_content(){
				...
				document.getElementById("pric1").innerHTML = await GetMaxBid() + "ETH" ;
				document.getElementById("auctend").innerHTML = await AuctionTime();
			fetch(url)
.then(res => res.json())
.then((out) => {
	img.src  = out["image"];
...
console.log(address_final);
                ...
                <div class="col-md-12 col-lg-6 col-sm-12 col-12">
					<div class="product-summary">
						  ...
						  <div class="price">Current maximum bid:<label id = "pric1">Price loading...</label></div>
						  <div class="price">Auction expires on: <label id = "auctend">Endtime loading...</label></div>
						  ...
						  <div class="cart-info clearfix">
								...
								<div class="button col-6 p-0">
								    <input type="text" id = "message" class="form-control" value= "Enter your bid in WEI...">
									<button type="submit" onclick="BidOn();"class="btncart">Bid on this auction</button>
								</div>
