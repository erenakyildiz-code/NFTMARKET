...
async function load_nft_content(id){
				...
				document.getElementById(pric[id]).innerHTML = await getnftprice() + "ETH" ;
			fetch(url)
.then(res => res.json())
.then((out) => {
	img.src  = out["image"];
...
async function load(id) {
    var val = 
	    <?php
	$cur_page = $_SESSION["pageId"];
    $sql_query = "SELECT * FROM address_nft WHERE ((uid <= ($cur_page* 9) + 9) AND (uid >= ($cur_page*9)+1)) ";
    $stack = [];
    ...
    if(await window.contract.methods.getApproved(1).call() == val[id]){
	...
	?></script><!-- this part is for val in the bottom part, it gets NFT address to pass on to the other page via javascript -->
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12 text-center pl-lg-5 pl-md-5 pl-sm-2 pl-2 mt-lg-0 mt-md-0 mt-sm-0 mt-5">
					<div class="row">
							...
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href+'?xyz='+val[0];return false;" ><h4><label id = "name1">Name loading...</label></h4></a>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4" id = 1>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[1];return false;" ><h4><label id = "name2">Name loading...</label></h4></a>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4" id = 2>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[2];return false;" ><h4><label id = "name3">Name loading...</label></h4></a>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4" id = 3>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[3];return false;" ><h4><label id = "name4">Name loading...</label></h4></a>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4" id = 4>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[4];return false;" ><h4><label id = "name5">Name loading...</label></h4></a>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4" id = 5>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[5];return false;" ><h4><label id = "name6">Name loading...</label></h4></a>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4" id = 6>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[6];return false;" ><h4><label id = "name7">Name loading...</label></h4></a>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4" id = 7>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
								<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[7];return false;" ><h4><label id = "name8">Name loading...</label></h4></a>
						...
						<!-- end single product -->
						<div class="col-lg-4 col-md-4 col-12" id = 8>
							<div class="single-shop-wrapper">
								<div class="single-shop">
									<div class="single-shop-img">
									...
									<div class="single-shop-meta">
									<a href="https://wastera.com/single_shop.php"onclick="location.href=this.href +'?xyz='+val[8];return false;" ><h4><label id = "name9">Name loading...</label></h4></a>
						...
						<div class="theme-pagination">
							<nav class="navbar justify-content-center">
							  <ul class="pagination">
								<li class="page-item"><a class="page-link" href="minus_bar_page.php"><i class="icofont icofont-long-arrow-left"></i></a></li> <!-- change_page(-1) -->
								...
								<li class="page-item"><a class="page-link" href="plus_bar_page.php"><i class="icofont icofont-long-arrow-right"></i></a></li>  <!-- change_page(1) -->
							  </ul>
							</nav>
						</div>
						<!-- end pagination -->
